...
#pragma region 描画初期化処理
	...
	result = LoadFromWICFile(
		L"Resources/texture4.png",   //「Resources」フォルダの「texture.png」
		WIC_FLAGS_NONE,
		&metadata, scratchImg);
